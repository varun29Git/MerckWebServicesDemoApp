...
public class EmployeeWebService {
	...
	public EmployeeWebModel createEmployee(@Valid @RequestBody EmployeeWebModel employee){
	 ...
	 public ResponseEntity<EmployeeWebModel> updateEmployee(@PathVariable(value = "id") Long empId, @RequestBody EmployeeWebModel employee){
		
		 EmployeeWebModel emp = employeeRepository.findById(empId).get();
